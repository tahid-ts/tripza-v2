...
const STYLE_CONFIGS: Record<SidebarVariant, StyleConfig> = {
  ...
  compact: {
    container: "bg-white rounded-lg shadow border border-gray-100",
    item: "px-3 py-2",
    iconSize: 16,
    width: "w-48",
    collapsedWidth: "w-16",
  ...
  floating: {
    container: "bg-white rounded-2xl shadow-xl border border-gray-200",
    item: "px-4 py-3",
    iconSize: 18,
    width: "w-64",
    collapsedWidth: "w-20",
      ...
      <>
        ...
        >
          <div className="flex justify-between p-4">
            ...
            >
              <RxCross2 size={28} className="text-primary cursor-pointer" />
            </button>
          </div>
  ...
  const MobileSidebar = useMemo(
    () => (
      <>
        ...
        <div
          className={clsx(
            "flex items-center justify-between px-4 py-2 rounded-full m-2 absolute top-0 left-0 right-0 border pointer-events-auto",
            Z.TOP,
          ...
          <div className="flex items-center justify-between p-5 shrink-0 border-b border-gray-200">
            <Link href="/" className="flex items-center gap-3">
              <Image
                ...
                style={{ height: "auto", width: "auto" }}
              />
              <h1 className="text-2xl font-bold text-primary">Tripza</h1>
            </Link>
            <button
              onClick={mobileControls.onToggle}
        ...
        {toggleDeskNavBar ? (
          <div className={clsx("relative", Z.TOP, "pointer-events-none")}>
            <div className="flex justify-center pointer-events-auto">
              <div
                className={clsx(
                  "flex justify-between items-center w-full absolute lg:max-w-[68.75%] md:max-w-[85%] xl:max-w-[80%] 2xl:max-w-[1320px] max-w-full xl:h-24 lg:h-20 md:h-16 mx-auto my-[30px] border rounded-full",
                  Z.TOP,
              ...
              >
                <Link href={"/"} className="cursor-pointer">
                  <div className="flex gap-2 p-6 items-center cursor-pointer">
                    ...
                    />
                    <h1
                      className={`text-2xl lg:text-5xl font-bold font-inter ${
                        toggleDeskNavCls ? "text-white" : "text-primary"
                      }`}
                    >
                      Tripza
                ...
                <div className={`px-12 ${Z.TOP} cursor-pointer`}>
                  <button
                    ...
                    className={clsx(
                      "rounded-full h-10 w-10 flex justify-center items-center transition-all duration-300 ease-out",
                      toggleDeskBtnClass
                    )}
                  >
                    {isDesktopVisible
                      ...
                      : toggleDeskIconOpen ?? (
                          ...
                          >
                            <path
                              d="M48 15.4171C48 16.0577 47.552 16.5775 47 16.5775H8.14283C7.59083 16.5775 7.14283 16.0577 7.14283 15.4171C7.14283 14.7766 7.59083 14.2567 8.14283 14.2567H47C47.552 14.2567 48 14.7766 48 15.4171ZM1 2.32085H47C47.552 2.32085 48 1.80098 48 1.16043C48 0.519872 47.552 0 47 0H1C0.448 0 0 0.519872 0 1.16043C0 1.80098 0.448 2.32085 1 2.32085ZM47 28.6791H17.1428C16.5908 28.6791 16.1428 29.199 16.1428 29.8396C16.1428 30.4801 16.5908 31 17.1428 31H47C47.552 31 48 30.4801 48 29.8396C48 29.199 47.552 28.6791 47 28.6791Z"
                              fill={`${toggleDeskNavCls ? "white" : "#C8C8C8"}`}
                            />
                          </svg>
                        )}
                  </button>
