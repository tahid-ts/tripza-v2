...
import { TourDetailsData } from "@/data";
...
export default function TourDetails() {
  ...
  const [expandedDay, setExpandedDay] = useState(
    tour.itinerary[0]?.day || null
  );
  const calculateTotal = () => {
    let total = adults * tour.adultPrice + children * tour.childPrice;
    if (serviceBooking) total += tour.serviceBookingPrice;
    if (serviceTraveler) total += tour.serviceTravelerPrice;
    return total;
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
              ...
              <div className="col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-1 gap-6">
                  {tour.heroImages.slice(1).map((img, i) => (
                    <Image
                      key={i}
                      src={img}
                      alt={`${tour.title} ${i + 1}`}
            ...
            <section>
              ...
              <ScrollAnimator repeatOnScroll effect="staggerSlideUp">
                <div className="grid xl:grid-cols-2 lg:grid-cols-1 grid-cols-1  gap-8">
                  ...
                  <div className="lg:w-96 order-2 md:order-1 xl:order-2">
                    <Image
            ...
            <ScrollAnimator repeatOnScroll effect="staggerSlideUp">
              <div className="bg-white rounded-xl  border border-gray-200 p-6 mb-6">
                ...
                <p className="text-sm text-gray-600 mb-5">
                  5-day guided tour with hotel stay. Max 9 travelers.
                </p>
                <div className="flex flex-wrap gap-4 text-sm text-gray-700 mb-6">
                  <div className="flex items-center gap-2 text-gray-700 bg-background px-4 rounded-full py-2.5">
                    <Hotel className="w-4 h-4" /> {tour.accommodation}
                  </div>
                  <div className="flex items-center gap-2 text-gray-700 bg-background px-4 rounded-full py-2.5">
